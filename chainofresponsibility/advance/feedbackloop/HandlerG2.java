...
public class HandlerG2 implements Handler {
    private final int handlerIndex;

    public HandlerG2(int idx) {this.handlerIndex = idx;}
    ...
    public FeedbackData feedback(int load) {
        ...
        data.setLoad(load);
        System.out.println("Feedback passed to Load Register from Handler G2 !!");
        return data;
    }

    @Override
    public int execute(Input input) {
        System.out.println("Handler G2 executed, accessing load !!");
