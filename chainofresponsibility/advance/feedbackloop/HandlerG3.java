...
public class HandlerG3 implements Handler {
    private final int handlerIndex;

    public HandlerG3(int idx) {this.handlerIndex = idx;}
    ...
    public FeedbackData feedback(int load) {
        ...
        data.setLoad(load);
        System.out.println("Feedback passed to Load Register from Handler G3 !!");
        return data;
    }

    @Override
    public int execute(Input input) {
        System.out.println("Handler G3 executed, accessing load !!");
